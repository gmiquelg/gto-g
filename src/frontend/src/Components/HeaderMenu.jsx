            ...
            <nav className="px-10 py-6 flex justify-between items-center">
                <ul className="flex gap-6 text-gray-200 font-medium items-center">
                    ...
                    <li className="flex items-center gap-2">
                        ...
                        <Link to="/" className="hover:text-[#fcd982] transition">Home</Link>
                    </li>
                    <li className="flex items-center gap-2">
                        <i className="bi-mortarboard-fill"></i>
                        <Link to="/study" className="hover:text-[#fcd982] transition">Study</Link>
                    </li>
                    <li className="flex items-center gap-2">
                        <i className="bi-play-fill text-xl"></i>
                        <Link to="/train" className="hover:text-[#fcd982] transition">Train</Link>
                    </li>
                </ul>
                <ul className="flex gap-5 text-gray-200 font-medium items-center">
                    <li className="flex items-center gap-2">
                        <i className="bi-person-fill"></i>
                        <Link to="/user" className="hover:text-[#fcd982] transition">Miquel G</Link>
